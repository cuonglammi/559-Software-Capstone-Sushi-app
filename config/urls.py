...
urlpatterns = [
    ...
    path('profile/', views.profile, name='profile'), path('profile/password/', views.password, name='password'),
    path('tables/', views.tables, name='tables'), path('tables/new/', views.new_session, name='new_session'),
    path('tables/<int:pk>/close/', views.end_session, name='end_session'),
    path('kitchen/', views.kitchen, name='kitchen'), path('kitchen/<int:pk>/status/', views.advance_order, name='advance_order'),
